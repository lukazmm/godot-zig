...
def generate_header():
    ...
    result.append("const builtin = @import(\"builtin.zig\");")
    result.append("const AABB = builtin.AABB;")
    result.append("const Rect2 = builtin.Rect2;")
    result.append("const Rect2i = builtin.Rect2i;")
    result.append("const Vector2 = builtin.Vector2;")
    result.append("const Vector2i = builtin.Vector2i;")
    result.append("const Vector3 = builtin.Vector3;")
    result.append("const Vector3i = builtin.Vector3i;")
    result.append("const Vector4 = builtin.Vector4;")
    result.append("const Vector4i = builtin.Vector4i;")
    result.append("const Transform2D = builtin.Transform2D;")
    result.append("const Transform3D = builtin.Transform3D;")
    result.append("const Basis = builtin.Basis;")
    result.append("const Projection = builtin.Projection;")
    result.append("const Plane = builtin.Plane;")
    result.append("const Quaternion = builtin.Quaternion;")
    result.append("const Color = builtin.Color;")
    result.append("")
    return result
...
def add_newlines(list):
    """
    Inserts newlines after every element of list
    """
    result = []
    for line in list:
        result.append(line + "\n")
